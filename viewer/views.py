...
# TODO musím mít registraci na Google pro API
import requests

from accounts.models import Profile
from viewer.forms import CreatorForm, MovieForm, GenreModelForm, CountryModelForm, ReviewModelForm, ImageModelForm
...
# TODO doplnit registaci na google pro API search
def search(request):
